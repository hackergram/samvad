...
function treeBoxes(urlService, jsonData)
{
	...
	var rectNode = { width : 250, height : 190, textMargin : 5 },
		tooltip = { width : 100, height : 50, textMargin : 5 };
	var i = 0,
		duration = 750,
		root;
	...
	// 1) ******************* Update the nodes *******************
		...
		.append('xhtml').html(function(d) {
				var		x=//'<div class="card">'+ d.nodeName +'</div>'
				'<div class="card">'
			//	+ '<img class="avatar" :src="picture">'

			//+'<img src="https://uinames.com/api/photos/female/5.jpg" class="landscape"">'
		 ...
		 +'<div class="col-md-6">'
          ...
          +'<img src="https://uinames.com/api/photos/female/5.jpg" class="landscape">'
					...
					+'<div class="col-md-6">'
					+'<div class="birth">'
					+	'<i class="fas fa-fw fa-birthday-cake"></i>'+ d.nodeName
					+'</div>'
					+'<div class="email">'
					+'<i class="fas fa-fw fa-envelope"></i>'+d.code
					+'</div>'
					+'<div class="phone">'
				  ...
				  +'</div>'
				 // +'</div>'
							// return '<div class="card" style="width: '

						//			+ (rectNode.width - rectNode.textMargin * 2) + 'px; height: '
						//ß			+ (rectNode.height - rectNode.textMargin * 2) + 'px;" class="node-text wordwrap">'
			//      +'<img src="https://uinames.com/api/photos/female/18.jpg" class="portrait" >'
